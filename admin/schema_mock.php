    ...
    'items' => [
        ...
        'sobre_nosotros' => [
            ...
            'sections' => [
                ...
                'transparencia_leyes' => [
                    'label' => 'SECCIÓN 7: TRANSPARENCIA Y LEYES',
                    'fields' => [
                        'div_texto' => ['type' => 'divider', 'label' => 'Textos de la página'],
                        'titulo' => ['type' => 'text', 'label' => 'Título', 'default' => 'Transparencia e Información Pública'],
                        'descripcion' => [
                            'type' => 'textarea',
                            'label' => 'Descripción',
                        ...
                        'buscador_placeholder' => ['type' => 'text', 'label' => 'Texto de ejemplo del buscador', 'default' => 'Buscar documento, resolución o presupuesto...'],
                        'div_secciones' => ['type' => 'divider', 'label' => 'Nombres de las secciones'],
                        'cat_info_financiera' => ['type' => 'text', 'label' => 'Nombre de la sección 1', 'default' => 'Información Financiera y Presupuestaria'],
                        'cat_rendicion_cuentas' => ['type' => 'text', 'label' => 'Nombre de la sección 2', 'default' => 'Rendición de Cuentas y Gestión'],
                        'cat_talento_humano' => ['type' => 'text', 'label' => 'Nombre de la sección 3', 'default' => 'Talento Humano'],
                        'cat_remuneracion_mensual' => ['type' => 'text', 'label' => 'Nombre de la sección 4', 'default' => 'Remuneración Mensual'],
                    ],
                ],
            ],
        ],
        'oferta_academica' => [
            ...
            'sections' => [
                ...
                // Las tarjetas del buscador van en la SECCIÓN 2, aquí debajo.
                // ---------------------------------------------------------
                'oferta_intro' => [
                    'label' => 'SECCIÓN 1: PRESENTACIÓN',
                    'fields' => [
                ...
                // ---------------------------------------------------------
                // SECCIÓN 2: las tarjetas del buscador. Antes solo se podían
                // tocar desde CONTENIDO → Programas Académicos, lejos de la
                // página a la que pertenecen; ahora se editan aquí mismo.
                // Las lee includes/oferta-programas.php y las filtra
                // js/oferta-programas.js sin recargar la página.
                // ---------------------------------------------------------
                'oferta_programas' => [
                    'label' => 'SECCIÓN 2: PROGRAMAS DEL BUSCADOR',
                    'fields' => [
                        'info_programas' => [
                            'type' => 'alert',
                            'alert_type' => 'info',
                        ...
                        'lista_programas' => [
                            ...
                            'item_label' => 'Programa',
                            'help' => 'El orden manda: así salen cuando "Ordenar por" está en Relevancia.',
                            'subfields' => [
                                'imagen' => [
                                    'type' => 'image',
                                    'label' => 'Foto del programa',
                                    'help' => 'Tamaño recomendado: 400x300px (apaisada).',
                                ],
                                'nombre' => [
                                    'type' => 'text',
                                ...
                                'facultad' => [
                                    'type' => 'text',
                                    'label' => 'Facultad',
                                    'help' => 'Línea azul debajo del nombre. Ej: Facultad de Salud y Servicios Sociales',
                                ],
                                'tipo' => [
                                    'type' => 'select',
                                    'label' => 'Aparece en',
                                    'default' => 'Programa',
                                    'help' => 'Con cuál de los dos botones de "Mostrar resultados por" sale esta tarjeta.',
                                    'options' => [
                                        'Programa' => 'Programas',
                                        'Curso' => 'Cursos',
                                    ],
                                ...
                                'campo_estudio' => [
                                    ...
                                    'help' => 'Filtro "Campo de Estudio" de la barra lateral.',
                                    'options' => [
                                ...
                                'etiqueta' => [
                                    ...
                                    'help' => 'Insignia azul de la esquina, que solo se ve al pasar el ratón por la tarjeta. Si lo dejas en "Ninguno" la página le pone uno sola, para que ninguna tarjeta se quede sin insignia.',
                                    'options' => [
                                        '' => 'Ninguno',
                                        'Nueva' => 'Nueva',
                                        'Destacada' => 'Destacada',
                            ...
                            'default' => [
                                [
                                    'imagen' => 'img/enfermeria.jpg',
                                    'nombre' => 'Tecnología Superior en Enfermería',
                                ...
                                [
                                    'imagen' => 'img/Mecanica.jpg',
                                    'nombre' => 'Tecnología Superior en Mecánica Automotriz',
                                ...
                                [
                                    ...
                                    'facultad' => 'Facultad de Ciencias Empresariales y Sistemas',
                                    'tipo' => 'Programa',
                                    'campo_estudio' => 'FACES',
                                    'modalidad' => 'Hibrida',
                                    'anio_inicio' => '2027',
                                ...
                                [
                                    'imagen' => 'img/programa_administracion.jpg',
                                ...
                                [
                                    'imagen' => 'img/programa_contabilidad.jpg',
                                ...
                                [
                                    'imagen' => 'img/programa_diseno_grafico.jpg',
                                    'nombre' => 'Tecnología Superior en Diseño Gráfico',
                                    'facultad' => 'Facultad de Ciencias Empresariales y Sistemas',
                                    'tipo' => 'Programa',
                                    'campo_estudio' => 'FACES',
                                    'modalidad' => 'Remoto',
                                ...
                                [
                                    'imagen' => 'img/programa_gastronomia.jpg',
                                    'nombre' => 'Tecnología Superior en Gastronomía',
                                    'facultad' => 'Facultad de Transporte y Vialidad',
                                    'tipo' => 'Programa',
                                    'campo_estudio' => 'FATV',
                                    'modalidad' => 'Presencial',
        ...
        'documentos_transparencia' => [
            ...
            'fields' => [
                'categoria' => [
                    'type' => 'select',
                    'label' => 'Sección *',
                    'help' => 'El documento aparecerá en este acordeón de la página pública.',
                    'required' => true,
                    'options' => [
                ...
                'nombre' => ['type' => 'text', 'label' => 'Nombre del documento *', 'help' => 'Ej.: Presupuesto Anual Institucional', 'required' => true],
                'anio' => ['type' => 'text', 'label' => 'Año *', 'help' => 'Ej.: 2026', 'required' => true],
                'archivo' => [
                    'type' => 'file',
                    'label' => 'Archivo PDF',
                    'help' => 'Selecciona un PDF de hasta 32 MB. En cuanto lo subas, su tamaño real reemplaza al de "Tamaño (provisional)".',
                    'accept' => '.pdf',
                    'allowed_exts' => ['pdf'],
                ],
                'tamano' => [
