...
return [
    ...
    'items' => [
        ...
        'himno_identidad' => [
            ...
            'type' => 'singleton',
            'fields' => [
                'div_textos' => ['type' => 'divider', 'label' => 'Textos del himno'],
                'titulo' => ['type' => 'text', 'label' => 'Título', 'default' => 'Música y letra'],
                'descripcion' => ['type' => 'textarea', 'label' => 'Descripción', 'default' => 'Nuestro himno representa la historia, los valores y el espíritu de excelencia de la comunidad bolivariana.'],
                'autor' => ['type' => 'textarea', 'label' => 'Autor'],
                'coro' => ['type' => 'textarea', 'label' => 'Coro'],
                'estrofa1' => ['type' => 'textarea', 'label' => 'Estrofa I'],
                'estrofa2' => ['type' => 'textarea', 'label' => 'Estrofa II'],
                'div_recursos' => ['type' => 'divider', 'label' => 'Audio e imagen'],
                'audio' => ['type' => 'audio', 'label' => 'Audio del himno', 'default' => 'audio/himnoitb.mp3'],
                'imagen' => ['type' => 'image', 'label' => 'Imagen del coro', 'default' => 'img/Himno_Estudiante_itb.jpg'],
                'btn_descargar' => ['type' => 'text', 'label' => 'Texto del botón de descarga', 'default' => 'Descargar música'],
                'nota_legal' => ['type' => 'textarea', 'label' => 'Nota legal'],
            ],
        ],
        'transparencia_leyes' => [
