...
<div class="top-bar">
    <div class="top-bar__container">
        ...
        <div class="top-bar__actions">
            ...
            <button class="top-bar__icon-btn top-bar__icon-btn--orange" id="accessibility-btn" aria-label="Accesibilidad">
        ...
        <nav class="navbar__menu" id="navbar-menu">
            <ul class="navbar__list">
                <li class="navbar__item navbar__item--dropdown">
                    ...
                    <ul class="navbar__dropdown" id="dropdown-instituto-menu">
                        <li><a href="#" class="navbar__dropdown-link">Misión y Visión</a></li>
                        <li><a href="#" class="navbar__dropdown-link">Historia</a></li>
                        <li><a href="#" class="navbar__dropdown-link">Autoridades</a></li>
                        <li><a href="#" class="navbar__dropdown-link">Campus</a></li>
                    </ul>
                </li>
                ...
                <li class="navbar__item navbar__item--dropdown">
                    ...
                    <ul class="navbar__dropdown" id="dropdown-vida-menu">
                        <li><a href="#" class="navbar__dropdown-link">Bienestar Estudiantil</a></li>
                        <li><a href="#" class="navbar__dropdown-link">Clubes y Organizaciones</a></li>
                        <li><a href="#" class="navbar__dropdown-link">Deportes</a></li>
                        <li><a href="#" class="navbar__dropdown-link">Eventos</a></li>
                    </ul>
                </li>
                <li class="navbar__item">
