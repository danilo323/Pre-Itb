    ...
    <div class="experiencia__container">
        ...
        <div class="experiencia__content">
            ...
            <p class="experiencia__description">
                En el ITB no solo te formamos académicamente; nos preocupamos por tu
                bienestar integral. Te ofrecemos beneficios exclusivos diseñados para
                apoyarte durante toda tu carrera universitaria.
            </p>

            <ul class="experiencia__list">
                <li class="experiencia__list-item">
                    <span class="experiencia__check"><i class="fas fa-check"></i></span>
                    <p><strong>Servicios Médicos Gratuitos</strong> (Podología, psicología, medicina general)</p>
                </li>
                <li class="experiencia__list-item">
                    <span class="experiencia__check"><i class="fas fa-check"></i></span>
                    <p><strong>Becas y Apoyo Económico</strong> (Académicas, deportivas y culturales)</p>
                </li>
                <li class="experiencia__list-item">
                    <span class="experiencia__check"><i class="fas fa-check"></i></span>
                    <p><strong>Gimnasio y SPA Gratis</strong> (Acceso exclusivo a ITB GYM)</p>
                </li>
                <li class="experiencia__list-item">
                    <span class="experiencia__check"><i class="fas fa-check"></i></span>
                    <p><strong>Modalidades a Tu Medida</strong> (Presencial, híbrida u online)</p>
                </li>
            </ul>
