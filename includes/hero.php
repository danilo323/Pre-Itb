...
<section class="hero" id="hero">
    ...
    <div class="hero__container">
        <div class="hero__content">
            <span class="hero__subtitle">Educación Superior de Excelencia</span>
            ...
            <p class="hero__description">
                Bienvenida al ITB. Formamos profesionales de alto nivel con educación práctica,
                tecnología e innovación para ayudarte a alcanzar el éxito laboral.
            </p>
            ...
            <div class="hero__actions">
                ...
                <div class="hero__stats">
                    <div class="hero__stat">
                        <span class="hero__stat-number">+20K Estudiantes Graduados</span>
                        <div class="hero__stat-rating">
                            ...
                            <span class="hero__rating-number">4.9</span>
                        </div>
                    </div>
                </div>
            </div>
